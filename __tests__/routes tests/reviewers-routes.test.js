const { getReviewer, getReviewers, getReviews, getReview, getUserAgent, getAdminAgent } = require('../../lib/helpers/data-helpers');
...
describe('reviewers routes', () => {
  ...
  it('requires a user to create a new reviewer', () => {
    return request(app)
  ...
  it('requires user to update a reviewer', async() => {
    const reviewer = await getReviewer();
  ...
  it('requires user to delete a reviewer', async() => {
